...
| 1.1.3 | 點擊S1Ch1連結，驗證進入課題頁面 | browser → click → snapshot | ⬜ |
| 1.1.4 | 返回首頁，點擊S1Ch2，驗證進入 | browser → click → snapshot | ⬜ |
| 1.1.5 | 抽查其他課題連結 (Ch4, Ch5, Ch10) | browser → click → snapshot | ⬜ |
...
| 1.2.5 | 點擊第一個遊戲，驗證進入遊戲頁面 | browser → click → snapshot | ⬜ |
| 1.2.6 | 點擊返回按鈕，驗證返回課題頁面 | browser → click → snapshot | ⬜ |
